...
const initialMockSurveys: Survey[] = [
    {
        ...
        questions: [
            { id: 1, text: 'Ümumi xidmətdən nə dərəcədə razısınız?', type: 'rating' },
            { id: 2, text: 'Kassada gözləmə müddəti qənaətbəxş idi?', type: 'choice' },
            { id: 3, text: 'Təklifiniz varmı?', type: 'text' },
        ],
        status: 'active',
    ...
    },
    {
        ...
        questions: [
            { id: 1, text: 'Meyvə və tərəvəzlər təzə idi?', type: 'rating' },
            { id: 2, text: 'Ən çox hansı şöbəni bəyənisiniz?', type: 'choice' },
        ],
        status: 'active',
    ...
    },
    {
        ...
        questions: [
            { id: 1, text: 'Aksiya qiymətlərini necə dəyərləndirirsiniz?', type: 'rating' },
            { id: 2, text: 'Hansı aksiya daha maraqlı idi?', type: 'choice' },
            { id: 3, text: 'Gələcək aksiyalar üçün təklifiniz?', type: 'text' },
        ],
        status: 'scheduled',
    ...
    },
    {
        ...
        questions: [
            { id: 1, text: 'Mağaza təmiz idi?', type: 'rating' },
            { id: 2, text: 'Naviqasiya asan idi?', type: 'choice' },
        ],
        status: 'paused',
    ...
    },
    {
        ...
        questions: [
            { id: 1, text: 'İşçilər yardımsevər idi?', type: 'rating' },
        ],
        status: 'completed',
    ...
    const handleCreate = () => {
        ...
        const survey: Survey = {
            ...
            questions: Array.from({ length: newSurvey.questionCount }, (_, i) => ({
                id: i + 1,
                text: `Sual ${i + 1}`,
                type: i === 0 ? 'rating' : i === 1 ? 'choice' : 'text' as const,
            })),
            status: 'draft',
